...
self.addEventListener('message', (event) => {
  if (event.data === 'skintec-skip-waiting') self.skipWaiting();
});

// Navigations: network first, fall back to the cached shell so SkinTec opens offline.
